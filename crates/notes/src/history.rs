...
impl HistoryManager {
    ...
    pub fn register_change_attributes(&mut self, target: HistoryStack, note_before_change: &Note) {
        log::trace!("History Register Change attribute: Note before: {note_before_change:?}");
    ...
    pub fn register_change_content(&mut self, target: HistoryStack, note_before_change: &Note) {
        log::trace!(
...
mod tests {
    ...
    fn sample_note(id: u32) -> Note {
        Note {
            ...
            created_at: Utc
                .with_ymd_and_hms(2024, 2, id + 1, 10, 11, 12)
                .unwrap(),
            updated_at: Utc
                .with_ymd_and_hms(2024, 2, id + 1, 10, 11, 12)
                .unwrap(),
