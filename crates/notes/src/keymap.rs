...
impl UICommand {
    pub fn get_info(&self) -> CommandInfo {
        match self {
            ...
            UICommand::CreateNote => CommandInfo::new(
                "Create new note",
                "Opens dialog to add a new note",
            ),
            ...
            UICommand::Undo => CommandInfo::new("Undo", "Undo the latest change on notes"),
            UICommand::Redo => CommandInfo::new("Redo", "Redo the latest change on notes"),
        }
    }
}
