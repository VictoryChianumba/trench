...
use crate::sorter::{SortCriteria, SortOrder, Sorter};
...
impl SortPopup {
    ...
    fn render_available_items(&mut self, frame: &mut Frame, area: Rect) {
        ...
        let block_style = match self.active_control {
            SortControl::AvailableList => Style::default().fg(Color::Yellow),
            _ => Style::default(),
        };
    ...
    fn render_applied_items(&mut self, frame: &mut Frame, area: Rect) {
        ...
        let block_style = match (self.is_valid, self.active_control) {
            ...
            (true, SortControl::AppliedList) => Style::default().fg(Color::Yellow),
            _ => Style::default(),
        };
    ...
    pub fn handle_input(&mut self, key: KeyEvent) -> SortReturn {
        ...
        match key.code {
            ...
            KeyCode::Char('d') if has_control => self.load_from_sorter(&Sorter::default()),
            _ => {}
        };
